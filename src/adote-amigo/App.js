					...
					return (
						<>
							...
							<DrawerItem
								...
								icon={() => (
									<IconButton icon="logout" size={20} iconColor={DefaultTheme.colors.primary} />
								)}
							/>
						</>
					);
			...
			>
				<Drawer.Screen
					...
					options={{
						...
						drawerIcon: () => (
							<IconButton icon="cat" size={20} iconColor={DefaultTheme.colors.primary} />
						),
					}}
				/>
				<Drawer.Screen
					...
					options={{
						title: "Favoritos",
						drawerIcon: () => (
							<IconButton icon="star" size={20} iconColor={DefaultTheme.colors.primary} />
						),
					}}
				/>
				<Drawer.Screen
					...
					options={{
						...
						drawerIcon: () => (
							<IconButton icon="dog" size={20} iconColor={DefaultTheme.colors.primary} />
						),
					}}
				/>
				<Drawer.Screen
					...
					options={{
						...
						drawerIcon: () => (
							<IconButton icon="account-circle" size={20} iconColor={DefaultTheme.colors.primary} />
						),
					}}
				/>
			</Drawer.Navigator>
